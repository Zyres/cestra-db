...
-- Sub area:1
-- ----------------------------
UPDATE `maps` SET `places`="cDcRc6djc7dxdLd0|eZfcfrfde1fFfUf9" WHERE `id`=183;
UPDATE `maps` SET `places`="gpgSgDg6gRhig5hh|eheieweKeYfaeJev" WHERE `id`=184;
UPDATE `maps` SET `places`="bDboa_bCbpbaaXaY|fNfzfOfke8flfAe9" WHERE `id`=908;
UPDATE `maps` SET `places`="ePeAel|d-eneC c" WHERE `id`=2016; -- House of the MAX-LoL (MapID:185)
UPDATE `maps` SET `places`="dHd-eneC|e4ePeAel" WHERE `id`=2015; -- House of the MAX-LoL (MapID:185)
UPDATE `maps` SET `places`="gzgOg2gNg1gygMhe|gggugIgXgJhahog_" WHERE `id`=185;
UPDATE `maps` SET `places`="eYfDf7fUfqfcfdeL|clbTbUbGb-bca1bt" WHERE `id`=912;
UPDATE `maps` SET `places`="fqfFfUf9gzgkf7fS|b-cncCcRcpcabXbI" WHERE `id`=914;
UPDATE `maps` SET `places`="d2dQcOc0d9ekeXeL|exeKdNd0c2ddedep" WHERE `id`=6146;
UPDATE `maps` SET `places`="gzg2gNg1gMgygkgj|cBdJdvdgducQc4cP" WHERE `id`=186;
UPDATE `maps` SET `places`="kCkVlbkUlaltlLls|jtjMjujbiVjciWiD" WHERE `id`=196;
UPDATE `maps` SET `places`="bQbPcgcfcIcHc-c9|fkfNfMgdgcgFgEg7" WHERE `id`=902;
UPDATE `maps` SET `places`="fxe5e6eCeDe7eEea|cjbRbQcicLchcKcg" WHERE `id`=913;
UPDATE `maps` SET `places`="dKdZdLdwdidxdjc6|bUbVb9clb8ckczcO" WHERE `id`=921;
-- ----------------------------
-- Amakna (Kawaii River)
-- sub-area: 479
-- ----------------------------
UPDATE `maps` SET `places`="fJfYfZfLfxfie5eQ|eYeJegdPdmc-cWcI" WHERE `id`=1461;
UPDATE `maps` SET `places`="cJdbdFd9eBe5fxf1|cYdqdUemeQfifMge" WHERE `id`=9448;
UPDATE `maps` SET `places`="eVf1fMfxekeMfcfe|dmcWcud9emd_dIdf" WHERE `id`=9452;
UPDATE `maps` SET `places`="g8gFgcfLfMgdgGg9|gOglfUfrhegNgkfT" WHERE `id`=45;
UPDATE `maps` SET `places`="bcbTclbHc2cyb6bp|c_cubmfGfVf7gjbN" WHERE `id`=46;
UPDATE `maps` SET `places`="d1dMdxeseGeUe8ds|dWdBdnc_cXd4ehew" WHERE `id`=261;
UPDATE `maps` SET `places`="eGeseDeLewdnc-cH|bWbHbsbdbtbea1aM" WHERE `id`=53;
UPDATE `maps` SET `places`="cscebNbkaUa8b3bm|eneCdJdYc5bFbGbI" WHERE `id`=178;
UPDATE `maps` SET `places`="bUb8b7cjb6cxc0dc|d1edeGeUe9e8e7fj" WHERE `id`=179;
UPDATE `maps` SET `places`="eKd5dCdoc_cIctcV|hlgUgrgegtgHgWg-" WHERE `id`=181;
UPDATE `maps` SET `places`="fEfTf8glgAgPfVfG|dhc4b-cncCcRc6dj" WHERE `id`=182;
UPDATE `maps` SET `places`="eqeEfefHcsb1b2ct|fBgIg4gPbGbHbebd" WHERE `id`=498;
UPDATE `maps` SET `places`="c5cRcCc6cScDcocp|bqbcbraZaLa0bdaM" WHERE `id`=766;
UPDATE `maps` SET `places`="cKcUdcdlcackb5cc|cdcmbVb4bKbTcicr" WHERE `id`=6143;
UPDATE `maps` SET `places`="fZgcgqf0gdgrgFgG|eheweieKeZeLexe0" WHERE `id`=679;
UPDATE `maps` SET `places`="bYcacocCc4dgdudI|cBcmb9bUc5didxdM" WHERE `id`=909;
UPDATE `maps` SET `places`="gRg6hjg7gTgEgpgD|d4eheweKeYeJeueg" WHERE `id`=680;
UPDATE `maps` SET `places`="eneBdVdHdtdEd6ew|fAflfzfNfZgpgRhh" WHERE `id`=251;
...
-- sub-area: 10
-- ----------------------------
UPDATE `maps` SET `places`="dnc_cXcJcYdadodC|gVgGgsgHgtgef2gf" WHERE `id`=688;
UPDATE `maps` SET `places`="eYeJeuc9cVcHcfb3|btbIepeagtgHgVg9" WHERE `id`=25;
UPDATE `maps` SET `places`="cpbYcacobJbXb_bI|fdfGfsfeftfHfVfW" WHERE `id`=687;
UPDATE `maps` SET `places`="fsfUgyf6gFgdfkfO|d7exfrfVfNflgIg-" WHERE `id`=675;
UPDATE `maps` SET `places`="a1bebtbHbVbGbrbd|gDgRg5gQgBgnf_go" WHERE `id`=708;
UPDATE `maps` SET `places`="dQdCdocYcKcwcib6|fmfOf2gegsgGgUg8" WHERE `id`=709;
UPDATE `maps` SET `places`="cacDdbdpblaKaZa8|gLgMg6gRgXb9b-" WHERE `id`=30;
UPDATE `maps` SET `places`="f_gogafXfJfYfKfv|cocacpcDcScEcTc7" WHERE `id`=35;
UPDATE `maps` SET `places`="eyd7dTdtdVeAeQ|eBe5eCd_eDfvfg" WHERE `id`=92;
UPDATE `maps` SET `places`="fNf1g3gPgBgQg4hg|c-cWcgb4bPbAbOb3" WHERE `id`=40;
UPDATE `maps` SET `places`="dHbhbKcbcabIbfbg|d9fGf9f8f7fEfbfc" WHERE `id`=705;
UPDATE `maps` SET `places`="d-eneQfhe4eBePeA|hfgOg2gzgNgkgygj" WHERE `id`=707;
UPDATE `maps` SET `places`="ekexeld_dZdNdAeZ|e-eKeyead0ebeoeA" WHERE `id`=6148;
UPDATE `maps` SET `places`="gcf0fMfydgdvdKdZ|eMe1feftdbcZcLcx" WHERE `id`=710;
UPDATE `maps` SET `places`="b8bUbGbsbebtbHa1|ehd6gmffgpeTeGdH" WHERE `id`=31;
UPDATE `maps` SET `places`="cAclaOaAaPa3a4bg|gygkgzgNg2gOe2ff" WHERE `id`=36;
UPDATE `maps` SET `places`="dbcYdadodCdQd5eA|elfxf0gcgqgEgpfM" WHERE `id`=41;
UPDATE `maps` SET `places`="bWbObXb5bPbycl|bQbZbRbJbsbBbA" WHERE `id`=463;
UPDATE `maps` SET `places`="d3dQdDeCePe2fcfo|b1cbcncabZcmczcX" WHERE `id`=465;
UPDATE `maps` SET `places`="c-cNdddBedfYfmeX|fxeLe0erebdMc1cM" WHERE `id`=464;
UPDATE `maps` SET `places`="dccXeLeBfweSge|cKdDfdf_grfzdH" WHERE `id`=461;
UPDATE `maps` SET `places`="b6cicwdqdadSd5eh|g7gUgGgsfMfkfzfO" WHERE `id`=462;
UPDATE `maps` SET `places`="gbgpgDgRfNf1gdgG|b1bNbzbla9aFaTa7" WHERE `id`=7;
UPDATE `maps` SET `places`="eleAfffufJfYfK|fhfvfge4ePe3eO" WHERE `id`=161;
UPDATE `maps` SET `places`="fee1eNezeOe3ffft|b3cQcCcocabYbKbw" WHERE `id`=957;
UPDATE `maps` SET `places`="fZfMfkeqdwc4cOcM|fmgIhlhigPfrd6db" WHERE `id`=952;
UPDATE `maps` SET `places`="f_fWfHfsepeadXdI|feftfIfXdWd_eoeD" WHERE `id`=534;
UPDATE `maps` SET `places`="frfGfVf-gngCgRg6|bobDbSb7ckcjb6bR" WHERE `id`=49;
UPDATE `maps` SET `places`="gagbgcgDgEgFg6g7|cichcgbPbQbRbobn" WHERE `id`=38;
UPDATE `maps` SET `places`="eBe3fXgpgogngRgQ|g-bTbSbRbobpbqaY" WHERE `id`=43;
UPDATE `maps` SET `places`="eQeofhfie6fLfZ|dHd-d_emeleze3" WHERE `id`=117;
UPDATE `maps` SET `places`="cjdbd7ddd9e1fVe3|cLdDexdFezfrfteB" WHERE `id`=51;
UPDATE `maps` SET `places`="eWeJewejdpdcc1cO|fNfAfnfaegd5dSdF" WHERE `id`=1665;
UPDATE `maps` SET `places`="d-dAc2dceYeod2dQ|dKdmc0cCdqdOeaey" WHERE `id`=1667;
UPDATE `maps` SET `places`="d0dMcScDcocwcib6|gsgegRgCgnfHfsfd" WHERE `id`=55;
UPDATE `maps` SET `places`="drdFdUdGdsdHdVd9|fjfxfLfZfKfwfhfv" WHERE `id`=1057;
UPDATE `maps` SET `places`="ezeld9dVdHdsdGdU|e4eQeCeod_dWd-em" WHERE `id`=1058;
UPDATE `maps` SET `places`="cLcwcicx|eSeDepeE" WHERE `id`=1059;
UPDATE `maps` SET `places`="g1frf-gUeCeVeFc4|dieafxgIffgQgOf7" WHERE `id`=942;
UPDATE `maps` SET `places`="czcKcRc1c_dkdvdG|bVb6cfcqcBcMdbdm" WHERE `id`=1065;
UPDATE `maps` SET `places`="cccpcCcOc0cNcAco|dqdCdOd1ecd2dQdD" WHERE `id`=1064;
UPDATE `maps` SET `places`="gTgFgrhlg9gVgHgt|csceb2bOcgcucIcW" WHERE `id`=34;
UPDATE `maps` SET `places`="fXfIfufJfvfge4fh|eld8ekezeNeyeMe1" WHERE `id`=1053;
UPDATE `maps` SET `places`="dXdIdtdHdWd_dVd-|d9emeAelezeOe2eN" WHERE `id`=1054;
UPDATE `maps` SET `places`="euegd4dQdCdodacY|b-cncCcRc6djdydN" WHERE `id`=39;
UPDATE `maps` SET `places`="gcgqgbgFgTgEgpgS|bQchb5bRcwcib6cx" WHERE `id`=44;
...
-- ----------------------------
-- Amakna (The Amakna Forest)
-- sub-area: 4
-- ----------------------------
UPDATE `maps` SET `places`="dHeDdJeBd9e5ebdf|dIeaeCd-eSdvdseP" WHERE `id`=949;
UPDATE `maps` SET `places`="c_dpdFd9ePe2fsfc|dndadqdUeAfffHfr" WHERE `id`=934;
UPDATE `maps` SET `places`="d8d7eyezePeQfhfg|bNblgefOcmbUfafE" WHERE `id`=612;
UPDATE `maps` SET `places`="e3ffftfgfvfufXgo|dncXcucSdjdMcocn" WHERE `id`=617;
UPDATE `maps` SET `places`="aLa0bda1bcaZbbaY|gAgPgBgngQgCgRgD" WHERE `id`=619;
UPDATE `maps` SET `places`="dldbcIcJc4c5dodx|cAcLcVdedvdkc_c1" WHERE `id`=6147; -- 0 enemies
UPDATE `maps` SET `places`="d1dib-e2freMd7ew|csb2bCcyc2eSgTgr" WHERE `id`=584;
UPDATE `maps` SET `places`="a9bzb3bBbfbHb_bJ|d5d6fVgnf0gqeceb" WHERE `id`=642;
UPDATE `maps` SET `places`="cLdbdFddc2cmdJeqay|gfgdfLfJbPblbNcf" WHERE `id`=577;
UPDATE `maps` SET `places`="cKcVdnc1c_dkdvdG|cdb5bVb6cfcqcLdb" WHERE `id`=1067; -- 0 enemies
UPDATE `maps` SET `places`="f2fAe8eScxbRbnbP|eZfpeMfIfVgngPfr" WHERE `id`=580;
UPDATE `maps` SET `places`="dGd9eAclc4ebfjfZ|dId_eCfXe1dScZcj" WHERE `id`=582;
UPDATE `maps` SET `places`="cucgcXdodRd6dpcY|bIbXcocRdidwcQcn" WHERE `id`=653;
UPDATE `maps` SET `places`="eQe4fhe5aWa_bna-|d4ehevegcPc4dgc3" WHERE `id`=663;
UPDATE `maps` SET `places`="ckb-d9dYe3f_hjgU|gMgifSfocXb1bkbm" WHERE `id`=665;
UPDATE `maps` SET `places`="fJgdf1fNfzfke8eU|evegd4ehd5dQdCfu" WHERE `id`=668;
UPDATE `maps` SET `places`="ejeldrendtczcBdv|bmbOa3bvfNflglfT" WHERE `id`=1087;
UPDATE `maps` SET `places`="bNa8bAaVaraIcsbj|feekeAfgdIcOcQdG" WHERE `id`=1079;
UPDATE `maps` SET `places`="eadYdKdZebepeqec|fde0eLewgmgBgQg5" WHERE `id`=578;
UPDATE `maps` SET `places`="cHbOgngAf3gWbHbd|fwfgezdTexfbddcy" WHERE `id`=579;
UPDATE `maps` SET `places`="dddDd2eVe8dXdyda|dNd0ebenezemd_dZ" WHERE `id`=1063; -- 0 enemies
UPDATE `maps` SET `places`="cZcxczeTdZfjgCgm|eefAePengkfpbPa_" WHERE `id`=581;
UPDATE `maps` SET `places`="boaWbnbmbQbPbOcg|e8eEe7fye6fxf0fw" WHERE `id`=654;
UPDATE `maps` SET `places`="f_gCgogRgDgpgEgS|cjckb8clcAcPdgdJ" WHERE `id`=664;
UPDATE `maps` SET `places`="cMcjbSbpcQcnbWbt|hggPgmfVhjgSgpfY" WHERE `id`=8763;
UPDATE `maps` SET `places`="fDfFfse2eldVcNbF|b1b2bObAa9bjbkaT" WHERE `id`=669;
UPDATE `maps` SET `places`="ducQc6dKeoe4eOd-|bAa-bBb3b4bCb5cv" WHERE `id`=1085;
UPDATE `maps` SET `places`="gTgFgqgEgDgogCgR|dRd6dDdSdqdbcZdc" WHERE `id`=1569;
UPDATE `maps` SET `places`="bXbJbvbKbYcacpcD|f_gnfWf-fHfVfsfG" WHERE `id`=586;
UPDATE `maps` SET `places`="b5bRbDbpbTb7cjcx|e8fkfyfMgef2fOfA" WHERE `id`=585;
UPDATE `maps` SET `places`="eUfmflfkfOfNfMge|bTclckcjcNcMcLdd" WHERE `id`=655;
UPDATE `maps` SET `places`="cNdddFd7ehdRdpcZ|gcgqgpgocncCc5dw" WHERE `id`=1069;
UPDATE `maps` SET `places`="glgAgPg4hgg3gOgz|cocabXb_bWbIbtbH" WHERE `id`=1072;
UPDATE `maps` SET `places`="bubIbXbtbgbva3a4|eLexeieMejd7ekdS" WHERE `id`=1071;
UPDATE `maps` SET `places`="dKecebeaeEeDeCe6|b3cucvcYaKaLbcbb" WHERE `id`=1091;
UPDATE `maps` SET `places`="cicxcjb6bEbqbFbT|fFfrfGfUgmf-gngB" WHERE `id`=8207;
UPDATE `maps` SET `places`="fke8eqecdwdicocC|eid5fceZdoc_cucf" WHERE `id`=286;
UPDATE `maps` SET `places`="cabXbIbtbWb_cnb-|f6gjgygNf7fTf8gk" WHERE `id`=287;
UPDATE `maps` SET `places`="eZfrfVgng4gAf8fE|bebIcacEcRcnbVbr" WHERE `id`=1070;
UPDATE `maps` SET `places`="cpcocBcNc2dddcdp|dDdPd2dQeZeNeBep" WHERE `id`=1076; -- 0 enemies
UPDATE `maps` SET `places`="c1cRcHcxcmcbclcw|c6dfdpdedodzdJdK" WHERE `id`=1075; -- 0 enemies
UPDATE `maps` SET `places`="d_eQfWgafve6fLep|e9fNgrezd9dTejcKci" WHERE `id`=1073;
UPDATE `maps` SET `places`="dmc-dndBdQdCdRd5|bYcabXbJbubIbtbf" WHERE `id`=1068;
UPDATE `maps` SET `places`="bEbFbGb9bHb-cBc4|e4eAd8dEeye2fufY" WHERE `id`=1086;
UPDATE `maps` SET `places`="c0cZcYdpdqdrdSej|dvdYepeSeodXeqeT" WHERE `id`=1105;
UPDATE `maps` SET `places`="eyekezeNeldUdrc0|cxcib6cjemeBePeA" WHERE `id`=279;
UPDATE `maps` SET `places`="f8gkgygMgzgNg1hd|clb9bVbHbebsbGbU" WHERE `id`=280;
UPDATE `maps` SET `places`="eFeTe7fjfxfLfZgb|eKeZfcfrfGfVf-gn" WHERE `id`=281;
UPDATE `maps` SET `places`="bybka8aUaVa-bnbC|gigxgMg1gNgzglf9" WHERE `id`=282;
UPDATE `maps` SET `places`="csbAcwdsekevfcdo|b2b4c0dUdqeMeic-" WHERE `id`=283;
UPDATE `maps` SET `places`="aGaHaIaJaYbbbqbF|f_f-f8fTfEfpfaeX" WHERE `id`=284;
UPDATE `maps` SET `places`="aZbcbrbFbUbGbVb-|c9dmdPd3egeueJdA" WHERE `id`=1106;
UPDATE `maps` SET `places`="gBg5eFe9btbVdocY|gCg4eGe8bsbWcXdp" WHERE `id`=1362;
UPDATE `maps` SET `places`="csb2bAa-docYcwb6|cIcgbQbocMdcdEd6" WHERE `id`=1101;
UPDATE `maps` SET `places`="decRcQcrdLdMd_ea|cDcEc3c4emdZdYdz" WHERE `id`=1565; -- 0 enemies
UPDATE `maps` SET `places`="fffefHfIeGeFe8e9|bVbUclcmcXcucvcY" WHERE `id`=1146;
UPDATE `maps` SET `places`="eQeleOfffufJfKfL|d9d-d_eoeDe6fxe4" WHERE `id`=276;
UPDATE `maps` SET `places`="eZeLe0fcfrfdfsfG|c4cQcBcPcAcmb9cl" WHERE `id`=277;
UPDATE `maps` SET `places`="b1cecscGcVc9dmdA|apaSaEaqaTaFaUa8" WHERE `id`=278;
UPDATE `maps` SET `places`="dpdTdSdRejeieheL|fvfYgpfZgqgTgrgU" WHERE `id`=1039;
UPDATE `maps` SET `places`="cWdnc_dCcXdodD|c4dvcQdhdKdwdic5" WHERE `id`=266;
UPDATE `maps` SET `places`="fVgmgnfWfue3e4fv|clbUbVcmcQcRdidh" WHERE `id`=1127;
UPDATE `maps` SET `places`="fHfWf_gogQgBgmf9|c5didxdMecdZdKdv" WHERE `id`=274;
UPDATE `maps` SET `places`="bkblbmbnaTaUaVaW|a_a-a9a8aIaHaGaF" WHERE `id`=275;
UPDATE `maps` SET `places`="d3egeveKeZfcfqfb|frfFfUfGfVf-gngC" WHERE `id`=264;
UPDATE `maps` SET `places`="chb5cicXdodCdRd5|gEgTgFgrgdf1fMfx" WHERE `id`=1092;
UPDATE `maps` SET `places`="exeZd5dDc_cJcfbP|cQdKeaeceEe8didg" WHERE `id`=1093;
UPDATE `maps` SET `places`="cncQcocRgegfgHgI|fUglgmfVbOcfcgbP" WHERE `id`=1140;
UPDATE `maps` SET `places`="fsfVftfWgnfXgogp|c4cCc5dwc6dxd0d1" WHERE `id`=273;
UPDATE `maps` SET `places`="gIgWg-hng_gXhaho|g0gMgygNg1hdheg2" WHERE `id`=268;
UPDATE `maps` SET `places`="aXbobRbnbpbSaYbq|cRdhdKdidjdLdMec" WHERE `id`=1090;
UPDATE `maps` SET `places`="eVe9fle8eTeFereG|b7ckczcNc1cMcxcj" WHERE `id`=271;
UPDATE `maps` SET `places`="cacpcbbZa4bha5aQ|cEcTc7cSbvbJbgbu" WHERE `id`=272;
